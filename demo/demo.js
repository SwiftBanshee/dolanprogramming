...
const DEMOS = [
  ...
  },
  {
	...
	desc: 'Local crane service in Shawville, QC, providing mobile crane rental, rigging & hoisting, heavy equipment transport, construction lifts, and 24/7 emergency service across the Pontiac and Outaouais regions for over 20 years.',
	tag: 'trades',
	tech: ['HTML', 'CSS', 'JS'],
  ...
  },
  {
	id: 'gavans',
	title: 'Gavan&apos;s Hotel',
	client: 'Demo Client — Bar',
	desc: 'Historic Gavan&apos;s Hotel in Quyon, QC, a beloved community pub since 1946 offering hearty meals, cold drinks, live music, and events in the heart of the Pontiac region.',
	tag: 'bar',
	tech: ['HTML', 'CSS', 'JS'],
	url: 'sites/gavans/',
	date: '2026-05-01',
  ...
  {
	id: 'shanes-tree-service',
	title: 'Shane&apos;s Tree Service',
	client: 'Demo Client — Trades',
	desc: 'Family-run tree service in Pontiac County, QC, specializing in tree removal, trimming & pruning, stump grinding, 24-hour emergency response, and land clearing with over 20 years of local expertise.',
	tag: 'trades',
	tech: ['HTML', 'CSS', 'JS'],
	url: 'sites/shanes-tree-service/',
	date: '2026-05-01',
	featured: true,
  },
  {
	id: 'thorne-mountain-floor-works',
	title: 'Thorne Mountain Floor Works',
	client: 'Demo Client — Trades',
	desc: 'need a desc ------ WIP',
	tag: 'trades',
	tech: ['HTML', 'CSS', 'JS'],
	url: 'sites/thorne-mountain-floor-works/',
	date: '2026-05-01',
	featured: true,
  },
  {
